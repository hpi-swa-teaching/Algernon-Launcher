# Algernon Launcher [![GitHub release](https://img.shields.io/github/release/numberpi/Algernon-Launcher.svg?label=small%20release&maxAge=0)](https://github.com/numberpi/Algernon-Launcher/releases/latest) [![Github All Releases](https://img.shields.io/github/downloads/numberpi/Algernon-Launcher/total.svg?maxAge=0)](https://github.com/numberpi/Algernon-Launcher/releases) [![Build Status](https://img.shields.io/travis/numberpi/Algernon-Launcher/master.svg?maxAge=0)](https://travis-ci.org/numberpi/Algernon-Launcher) [![Coverage Status](https://img.shields.io/coveralls/numberpi/Algernon-Launcher/master.svg?maxAge=0)](https://coveralls.io/github/numberpi/Algernon-Launcher?branch=master)
...
## Installation
Follow our [setup guide](https://github.com/numberpi/Algernon-Launcher/wiki/Setup-Guide) to install Algernon.
...
For explanations regarding the usage of the features check out the [wiki](https://github.com/numberpi/Algernon-Launcher/wiki).
